...
const HeemangPage: React.FC = () => {
    ...
    const imageUrls = equipmentList.map(equipmentName => `/img/Gyms/Heemang/${equipmentName}.jpg` );

    return (
        <div className="gymContainer">
            <Banner gymName="Heemang" />
            <h1>Heemang Page</h1>
