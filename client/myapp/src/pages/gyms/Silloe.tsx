...
const SilloePage: React.FC = () => {
    ...
    const imageUrls = equipmentList.map(equipmentName => `/img/Gyms/Silloe/${equipmentName}.jpg` );

    return (
        <div>
            <Banner gymName="Silloe" />
            <h1>Silloe Page</h1>
